...
export class HomePage {
  ...
  constructor() {
    this.metaService.setMetaTags(
      ...
      'Dive into my portfolio, a passionate aspiring front-end developer based in the Philippines. Explore the intricacies of my journey, from personal details to exciting projects. Join me on this virtual exploration of technology, creativity, and more.',
      [
        'Harvey S. Tapang',
        'Harvey Tapang',
        'harveystapang',
